...
def test_reconcile_preserves_orbstack_preamble(svc: SshManagerService) -> None:
    ...
    # An OrbStack-style preamble exists BEFORE ssh-manager has ever written the config.
    cfg.write_text(
    ...
    assert "Include profiles/*/config" in text        # ssh-manager block added below it
